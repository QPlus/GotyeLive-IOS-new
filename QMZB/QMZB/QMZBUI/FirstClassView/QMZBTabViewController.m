...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (!AppDelegateInstance.userInfo.isLogin) {
        ...
        if (account.length != 0) {
            ...
            QMZBAllLoginController *loginController = [[QMZBAllLoginController alloc] init];
...
//            [self presentViewController:loginController animated:NO completion:nil];
...
#endif
            chat.isLiveMode = 1;
            chat.itemTag = _itemtag;
            chat.roomId = AppDelegateInstance.userInfo.liveRoomId;
            chat.password = AppDelegateInstance.userInfo.liveRoomanchorPwd;
            ...
            UINavigationController *na = [[UINavigationController alloc] initWithRootViewController:channel];
            CATransition *animation = [CATransition animation];
            animation.duration = 0.3;
            animation.timingFunction = UIViewAnimationCurveEaseInOut;
            animation.type = kCATransitionPush;
