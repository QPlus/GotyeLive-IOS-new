...
- (void)initNavigationBar
{
    ...
    //设置bar的frame
    _searchBar.frame=CGRectMake(0, 0, ScreenWidth - 100, 30);
...
//                    for (NSDictionary *dictionary in array) {
                        ...
                        model.playRtmpUrl = [NSString jsonUtils:[dics objectForKey:@"playRtmpUrl"]];
                        model.playHlsUrl = [NSString jsonUtils:[dics objectForKey:@"playHlsUrl"]];
                        model.playFlvUrl = [NSString jsonUtils:[dics objectForKey:@"playFlvUrl"]];
...
//        QMZBLiveListModel *model = [[QMZBLiveListModel alloc]init];
        QMZBLiveListModel *model = _searchArrays[indexPath.row];
...
//    loginController.playUrl = obj.playFlvUrl;
//
...
//    [self presentViewController:loginController animated:YES completion:nil];
    ...
    //    [chat setModalTransitionStyle:UIModalTransitionStyleFlipHorizontal];
