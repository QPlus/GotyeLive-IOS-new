...
@implementation QMZBAreaView

-(QMZBLocationModel *)locate
{
    if (_locate == nil) {
        _locate = [[QMZBLocationModel alloc] init];
    }
...
- (id)initWithdelegate:(id<QMZBAreaPickerDelegate>)delegate
{
    ...
    self = [[[NSBundle mainBundle] loadNibNamed:@"QMZBAreaView" owner:self options:nil] objectAtIndex:0];
    if (self) {
